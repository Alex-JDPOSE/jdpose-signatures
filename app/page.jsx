...
export default function Home() {
  ...
  // Charge un ancien bon dans le formulaire pour le modifier
  const editPast = (sig) => {
    setEditingId(sig.id);
  ...
  // Régénère et télécharge le PDF d'un bon existant (visualisation)
  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      // Si on modifie un bon existant → update, sinon → insert
      if (editingId) {
